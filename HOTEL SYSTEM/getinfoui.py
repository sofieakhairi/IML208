...
class HOTEL_MANAGEMENT:
    def __init__(self):
        def gotinfo():
            self.gotinfo = str(self.gather.get())
            print(self.gotinfo)
            print("\n")
            if self.gotinfo.isdigit() == True and len(self.gotinfo) != 0:
            ...
            try:
                ...
                while True:
                    ...
                    if self.gotinfo == a:
                        ...
                        print("\n")
                        print("MOBILE NUMBER-", "  ", s.mobile_no)
                        print("\n")
                        print("THE TOTAL BILL IS RM", s.price)
                    elif EOFError:
                        if n == 0:
                            print("NO GUEST IN ROOM ", self.gotinfo)
                        else:
                            n = 0
                            continue
            except EOFError:
        ...
        self.Message1.configure(text='''Get Guest Info''')
