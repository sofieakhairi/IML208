...
class HOTEL_MANAGEMENT:
    def __init__(self):
        ...
        _fgcolor = '#000000'  # X11 color: 'blue'
        ...
        self.Message6.place(relx=0.11, rely=0.01, relheight=0.15, relwidth=0.86)
        self.Message6.configure(background="#d9d9d9")
        self.Message6.configure(font=font16)
        self.Message6.configure(foreground="#000000")
        self.Message6.configure(highlightbackground="#d9d9d9")
        self.Message6.configure(highlightcolor="gold")
        self.Message6.configure(text='''THE REGA HOTEL''')
