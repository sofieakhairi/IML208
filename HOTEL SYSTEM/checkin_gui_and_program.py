    ...
    def __init__(self):
        ...
        def chk_name():
            while True:
                ...
                if len(self.k) != 0 and a != True:
                    self.NAME=self.k
                    self.Text1.insert(INSERT, "name has been key in""\n")
                    break
                else:
                    self.Text1.insert(INSERT, "invalid name please input a valid name""\n")
        ...
        def chk_add():
            while True:
                ...
                if len(self.g)!= 0 and ak!=True:
                    ...
                    self.Text1.insert(INSERT, "address has been key in""\n")
                    break
                else:
                    self.Text1.insert(INSERT, "invalid address please input a valid address""\n")
        ...
        def chk_mo():
            while True:
                ...
                if self.h.isdigit() == True and len(self.h) != 0 and len(self.h) == 10:
                    self.MOBILE = self.h
                    self.Text1.insert(INSERT, "mobile number has been key in""\n")
                    break
                else:
                    self.Text1.insert(INSERT, "invalid, please input a valid mobile number""\n")
                break
        ...
        def chk_day():
            while True:
                ...
                if self.l.isdigit() == True and len(self.l) != 0:
                    ...
                    self.Text1.insert(INSERT, "days has been key in""\n")
                    break
                else:
                    self.Text1.insert(INSERT, "invalid days ""\n")
                    break
        ...
        def tor(self):
            ...
            if self.ch == 1:
                ...
                self.price = self.price + (230 * self.no_of_days)
                m[0] = 2
            elif self.ch == 3:
                self.price = self.price + (300 * self.no_of_days)
                m[0] = 3
            elif self.ch == 4:
                self.price = self.price + (340 * self.no_of_days)
                m[0] = 4
        ...
        _ana1color = '#ffffff' # X11 color: 'silver'
        _ana2color = '#ffffff' # X11 color: 'silver'
        ...
        self.Message1.configure(text='''YOU ARE ON PAGE''')
        ...
        self.Label4.configure(text='''ENTER YOUR PHONE NUM''')
        ...
        self.Label6.configure(text='''CHOOSE TYPE OF ROOM''')
        ...
        self.Checkbutton4.configure(text='''STUDIO''')
